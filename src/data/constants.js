export const DEFAULT_PRIZE_OBJ = { title: "", desc: "", img: "" };

export const LOCATIONS = {
  "Kocaeli": {
    "Başiskele": ["Atakent", "Aydınpınar", "Barbaros", "Camidüzü", "Damlar", "Doğantepe", "Döngel", "Fatih", "Havuzlubahçe", "Karadenizliler", "Kılıçarslan", "Körfez", "Ovacık", "Paşadağ", "Sahil", "Serdar", "Seymen", "Şehitekrem", "Vezirçiftliği", "Yeniköy", "Yeşilyurt", "Mahmutpaşa", "Aydınkent", "Yaylacık", "Altınkent", "Yeşilkent", "Kullar Yakacık", "Yuvacık Yakacık", "Mehmetağa", "Kullar Tepecik", "Sepetlıpınar"],
    ...
    "Körfez": ["Mimar Sinan", "Yarımca", "Tütünçiftlik", "Hacı Osman", "Atalar", "Ağadere", "Barbaros", "Çamlıtepe", "Esentepe", "Fatih", "Güney", "İlimtepe", "Kuzey", "Şirinyalı","Yeniyalı", "Yavuz Sultan Selim", "Cumhuriyet", "17 Ağustos", "Kirazlıyalı", "Yukarı Hereke", "Kışladüzü", "Hacı Akif", "Agah Ateş"]
  },
  "Sakarya": {
    ...
    "Kocaali": ["Ağalar", "Aktaş", "Alandere", "Caferiye", "Demiraçma", "Gümüşoluk", "Hızar", "Karşı", "Kestanepınarı", "Kirazlı", "Merkez", "Şerbetpınar", "Yalı", "Yalpankaya", "Yanıksayvant", "Yayla", "Yeni"],
    ...
    "Erenler": ["Alancuma", "Bağlar", "Büyükesence", "Çaybaşıyeniköy", "Değirmendere", "Dilmen", "Ekinli", "Erenler", "Hacıoğlu", "Hasanbey", "Horozlar", "Kamışlı", "Kayalarmemduhiye", "Kayalarreşitbey", "Kozluk", "Küpçüler", "Nakışlar", "Pirahmetler", "Sarıcalar", "Şeyhköy", "Tabakhane", "Yazılı", "Yeni", "Yeşiltepe", "Çaykışla", "Bekirpaşa", "Hürriyet", "Tepe", "Emirler", "Küçükesence", "Tuapsalar"],
